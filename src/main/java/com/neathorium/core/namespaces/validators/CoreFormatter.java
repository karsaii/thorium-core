...
import com.neathorium.core.constants.formatter.NumberConditionDataConstants;
import com.neathorium.core.extensions.DecoratedList;
import com.neathorium.core.extensions.interfaces.IEmptiable;
...
import com.neathorium.core.records.reflection.message.InvokeParameterizedMessageData;
...
public interface CoreFormatter {
    ...
    static String getInvokeMethodCommonMessage(InvokeCommonMessageParametersData data, Exception exception) {
        return (CoreUtilities.areNotNull(data, exception) && CoreUtilities.areNotBlank(data.message, data.parameterTypes, data.returnType)) ? (
    ...
    static String getInvokeMethodParameterizedMessage(InvokeParameterizedMessageData data, Exception exception) {
        if (CoreUtilities.areAnyNull(data, exception) || CoreUtilities.areAnyBlank(data.message, data.parameterTypes, data.returnType)) {
